...
minor_grid_width_(DEFAULT_WIDTH), major_grid_width_(DEFAULT_WIDTH), label_grid_width_(DEFAULT_WIDTH),
...
tick_length_(0), tick_width_(DEFAULT_WIDTH), major_step_(MAJOR_STEP),label_step_(LABEL_STEP),
